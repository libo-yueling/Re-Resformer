...
def main():
    ...
    # Remove pred_scores from result for demonstration purposes
    result.pop('pred_scores', None)

    # Check if 'pred_roughness' exists in the result
    if 'pred_roughness' in result:
        print(f"Predicted Roughness: {result['pred_roughness']}")
    else:
        print("No roughness prediction found in the result.")

    # Print the rest of the result as JSON
