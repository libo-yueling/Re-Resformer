...
class Re(CustomDataset):
    ...
    def load_data_info(self, data_root: str, split: str):
        ...
        with open(ann_file_path, 'r') as f:
            for line in f:
                ...
                img_path = parts[0]
                roughness_value = float(parts[1])  # Roughness value
                ...
                data_info.append((img_path, roughness_value))
    ...
    def __getitem__(self, index):
        ...
        img_path, roughness_value = self.data_info[index]
